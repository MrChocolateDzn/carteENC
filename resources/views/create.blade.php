      ...
      <form method="post" action="{{url('demandeCarte')}}" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="row">
              <div class="col-md-4"></div>
              <div class="form-group col-md-4">
                  <label for="Fichier">Sélectionnez une photo d'identité: </label>
                  <input type="file" value="Choisir un fichier" class="form-control" name="Fichier" accept="image/png, image/jpeg">
              </div>
          </div>
